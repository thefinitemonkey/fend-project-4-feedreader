...
$(function () {
    ...
    */
    ...
    describe('Initial Entries', function () {
        ...
        it('has at least a single entry when it loads', function () {
            var container = document.getElementsByClassName("feed")[0];
            var entries = container.getElementsByClassName("entry");
    ...
    describe('New Feed Selection', function () {
        ...
        it('changes the content when switching feeds', function () {
